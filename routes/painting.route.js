...
router.route('/get-paintings-by-author-id/:authorId').get(trimRequest.all, get_paintings_by_author_id)
router.route('/get-by-id-painting/:paintingId').get(trimRequest.all, get_painting_by_id)
